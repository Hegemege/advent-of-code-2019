...
class Node:
    ...
    def set_depth(self, depth, key_lookup):
        self.depth = depth
        for neighbor in self.neighbors:
            ...
            if neighbor.depth <= self.depth + 1:
                continue
            # If there is no key
            if neighbor.isDoor and key_lookup[neighbor.value.lower()] is False:
                continue
            neighbor.set_depth(self.depth + 1, key_lookup)
